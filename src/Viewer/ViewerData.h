...
//Input Mesh
	...
	void UpdateMeshView(igl::opengl::glfw::Viewer& viewer, bool ShowPolygonalEdges, bool ShowVertexSpheres)
	{
		if (V.cols() != 3) {
			return;
		}
		...
		if (ShowVertexSpheres) {
			...
			hedra::point_spheres(V, 0.02, sphereColors, 10, sphereV, sphereT, sphereTC);
		}
	...
	void UpdateMeshView(igl::opengl::glfw::Viewer& viewer, char key) {
		using namespace std;
